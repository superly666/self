...
<div id="urHere">DouPHP 管理中心<b>></b><strong>网站管理员</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="<?php echo U('User/add');?>" class="actionBtn">添加管理员</a>网站管理员</h3>
     ...
     <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
      ...
      <td align="center"><?php echo ($vol["email"]); ?></td>
      <td align="center"><?php echo ($vol["role_id"]); ?></td>
      <td align="center"><?php echo ($vol["addtime"]); ?></td>
      <td align="center"><?php echo ($vol["last_login_time"]); ?></td>
      <td align="center"><a href="/index.php/Admin/User/edit/id/<?php echo ($vol["id"]); ?>">编辑</a> | <a href="/index.php/Admin/User/dele/id/<?php echo ($vol["id"]); ?>">删除</a></td>
