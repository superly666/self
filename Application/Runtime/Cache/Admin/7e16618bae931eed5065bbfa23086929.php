    ...
    <tr>
     ...
     <tr>
      <td width="350" valign="top">
       <form action="<?php echo U('Doc/addok');?>" method="post" enctype="multipart/form-data">
...
<input type="text" name="name" value="" size="20" class="inpMain" />
         ...
         <tr>
          <td><b>幻灯图片</b>
           <input type="file" name="file" class="inpFlie" />          </td>
         </tr>
         <tr>
          <td><b>图片描述</b>
           <input type="text" name="content" value="" size="40" class="inpMain" />
          </td>
         </tr>
         <tr>
          <td><b>排序</b>
      ...
      <td valign="top">
       <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableOnebor">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
         ...
         <td align=""><?php echo ($vol["content"]); ?></td>
