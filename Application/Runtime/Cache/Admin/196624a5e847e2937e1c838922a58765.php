...
<div id="urHere">DouPHP 管理中心<b>></b><strong>文章列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <div class="filter">
    <form action="/self/index.php/Admin/Article/article" method="post">
     <select name="cat_id">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
      ...
      <th align="left" width="150">文章名称</th>
     ...
     <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
      ...
      <td><a href="article.php?rec=edit&id=10"><?php echo ($vol["article_name"]); ?></a></td>
     
      <td align="center"><a href="article.php?cat_id=1"><?php echo ($vol["category_name"]); ?></a></td>
      <td align="center"><?php echo (date('Y-m-d H:i:s',$vol["addtime"])); ?></td>
      <td align="center">
              <a href="/self/index.php/Admin/Article/edit/id/<?php echo ($vol["id"]); ?>">编辑</a> 
             </td>
     ...
     <select name="new_cat_id" style="display:none">
      <option value="0">未分类</option>
       ...
       <a href="javascript:;" class="del">
                 <font color="red" size="4"><b>-->执行</b></font>
                 </a>
    </div>
    </form>
    </div>
...
<script type="text/javascript">
 $(function(){
    ...
    $('.del').on('click',function(){
        ...
        //console.log(ids);
        window.location.href = '/self/index.php/Admin/Article/del/ids/' + ids;
    });
